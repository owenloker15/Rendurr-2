...
namespace Rendurr
{
...

    {
        ...
        EventPublisher::getInstance()->subscribe<MouseReleaseEvent>(
            this, &CameraController::onMouseReleaseEvent);
        EventPublisher::getInstance()->subscribe<MouseMoveEvent>(
            this, &CameraController::onMouseMoveEvent);
        EventPublisher::getInstance()->subscribe<MouseScrollEvent>(
